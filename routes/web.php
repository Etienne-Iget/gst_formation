...
Route::middleware(['auth:sanctum', 'verified','authadmin'])->get('/admin/dashboard',[App\Http\Controllers\ModulesController::class,'show_dash'])->name('admin.dashboard');
...
Route::middleware(['auth:sanctum', 'verified','authadmin'])->get('/admin/modules',[App\Http\Controllers\ModulesController::class,'show_Modules'])->name('admin.modules');
...
Route::middleware(['auth:sanctum', 'verified','authadmin'])->get('/admin/cours',[App\Http\Controllers\CoursController::class,'show_cours'])->name('admin.cours');
